...
def read_ph_res_results_data(ObsID='90089-11-03-01G',model='cutoffpl_en_fix',
    ...
    fasebin_file=fits.open(f'/Users/s.bykov/work/xray_pulsars/rxte/results/out{ObsID}/products/fasebin/fasebin_orig.pha',mode='read')
    ...
    return phase,
    flux312,flux312_err,
    norm_line,norm_line_error,





#%% marat's comments: edges and other stuff
