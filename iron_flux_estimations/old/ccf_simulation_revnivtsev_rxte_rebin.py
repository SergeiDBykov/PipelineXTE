...
def iron_band_model_lc(lc712,A,deltaT):
    ...
    tmpcounts=np.roll(lc712_cts,int(deltaT/lc.dt))
...
ax_ccf.set_xlim(-70,70)
ax_ccf.set_ylim(-0.1,1)
...
plot_ccf('ccf_5sec.qdp',ax_ccf)

ax_ccf.set_xlabel('iron delay, s')
ax_ccf.legend()
plt.savefig(f'simulations/ccf_dt{deltaT}s_A{A}_rebin.png')
