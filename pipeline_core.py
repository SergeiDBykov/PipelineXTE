...
def fit_const_chi_square(data,error):
    model=np.average(data,weights=1/error**2)
    chi2=np.sum((data-model)**2/(error**2))
    dof=len(data)-1
    chi2_red=chi2/dof
    pval=stats.chi2.sf(chi2,dof) #probability of null hypotesis (model is constant)
    return model,chi2,chi2_red,pval
...
ObsList_all=['90089-11-01-00', '90089-11-01-02', '90089-11-01-03',
       ...
       '90089-11-02-03G', '90089-11-02-03', '90089-11-02-07',
       '90089-11-02-04', '90089-11-02-10', '90089-11-02-09',
       '90089-11-02-08', '90089-11-03-03', '90089-11-03-04',
       '90089-11-03-00G', '90089-11-03-01G', '90089-11-03-02',
       '90089-11-03-05', '90089-11-04-00G', '90089-11-04-01',
       '90089-11-04-02G', '90089-11-04-03', '90089-11-04-04',
       '90089-11-04-05', '90089-11-05-00G', '90089-22-01-00G',
       '90089-22-01-01G', '90089-11-05-01', '90089-11-05-08G',
       '90089-11-05-02', '90427-01-01-00G', '90427-01-01-01',
       '90427-01-01-02', '90427-01-01-03', '90427-01-02-02',
       '90427-01-02-03', '90014-01-01-00', '90014-01-01-06',
       '90014-01-01-07', '90014-01-01-03', '90014-01-01-02',
       '90014-01-01-01', '90014-01-01-04', '90014-01-01-05',
       '90427-01-03-00', '90427-01-03-01', '90427-01-03-02',
       '90014-01-02-03', '90427-01-03-14G', '90014-01-02-00',
       '90427-01-03-05', '90014-01-02-10', '90427-01-03-06',
       '90427-01-03-07', '90014-01-02-08', '90427-01-03-09',
       '90427-01-03-11', '90014-01-02-15', '90427-01-03-12',
       '90014-01-02-13', '90014-01-03-00', '90014-01-03-01',
       '90014-01-03-020', '90014-01-03-02', '90014-01-03-03',
       '90014-01-04-00', '90014-01-04-01', '90014-01-04-02',
       '90014-01-04-03', '90014-01-05-00', '90014-01-05-01',
       '90014-01-05-04', '90014-01-05-05', '90014-01-05-02',
       '90014-01-05-06', '90427-01-04-00', '90427-01-04-04',
       '90014-01-06-00', '90427-01-04-02', '90427-01-04-03',
       '90427-01-04-05', '90014-01-06-01', '90427-01-04-01',
       '90014-01-06-02', '90014-01-06-03', '90014-01-07-01',
       '90014-01-07-03']

ObsList_SA=['90089-11-03-00G', '90089-11-03-01G', '90089-11-03-02',
       '90427-01-03-00', '90427-01-03-01', '90427-01-03-02',
       '90014-01-02-03', '90427-01-03-14G', '90014-01-02-00',
       '90427-01-03-05', '90014-01-02-10', '90427-01-03-06',
       '90427-01-03-07', '90014-01-02-08', '90427-01-03-09',
...
ObsList_SE=['90089-11-01-02', '90089-11-01-03', '90089-11-01-04',
       '90089-11-02-00', '90089-11-02-05', '90089-11-02-06',
       '90089-11-02-01', '90089-11-02-02', '90089-11-02-03G',
       '90089-11-02-03', '90089-11-02-07', '90089-11-02-04',
       '90089-11-02-10', '90089-11-02-09', '90089-11-02-08',
       '90089-11-03-03', '90089-11-03-04', '90089-11-03-05',
       '90089-11-04-00G', '90089-11-04-01', '90089-11-04-02G',
       '90089-11-04-03', '90089-11-04-04',
       '90014-01-05-00', '90014-01-05-01', '90014-01-05-04',
       '90014-01-05-05', '90014-01-05-02',
       '90427-01-04-00', '90427-01-04-04',
       '90427-01-04-02', '90427-01-04-03', '90427-01-04-05',
       '90014-01-06-01', '90427-01-04-01', '90014-01-06-02']
...
class ObservationXTE():
    ...
    def filter_time(self):
        ...
        path_to_data=self._data_path_
        xtefilt=' xtefilt -c -a {0} -o {1} -p {2} -t 0.1 -f FILTERFILE'.format(appidlist_path,self.ObsID,path_to_data)
    ...
    def fit_ph_res(self,model='cutoffpl',chmin=0,chmax=8,error=0.00):
        '''
        ...
        if conf=='se':
            ...
            model=model
        os.system(f'xspec - /Users/s.bykov/work/xray_pulsars/rxte/python_pca_pipeline/xspec_scripts/ph_res/ph_res_{model}.txt')
...
#             # #%%FOR PAPER: PLOT BOTH NEG AND POS DELAYS OF EQW
...
#             # sns.despine(fig,top=1,right=0)
#             # #sns.set(font_scale=0.5)
#             # fig.savefig(f'Day{mjd}_ph_res_{ObsID}_{model}_for_paper.pdf',dpi=500)
...
#             #%%FOR database WITH POS AND NEG DELAYS
...
#             #CCF=cross_correlation.CrossCorrelation(phase*period,norm_line,flux712,circular=True)
#             lag,ccf=CCF.calc_ccf()
#             ccf_tmp=ccf[(lag>=-2.5) & (lag<=2.5)]
#             lag_tmp=lag[(lag>=-2.5) & (lag<=2.5)]
#             peaks=argrelextrema(ccf_tmp, np.greater_equal)
#             delays=lag_tmp[peaks]
#             absmax=lag_tmp[np.argmax(ccf_tmp)]

#             print(delays)
#             print(absmax)

#             self.write_to_obs_info(self.fasebin_info_file,'deltat_pos',delays[delays>0][0])
#             self.write_to_obs_info(self.fasebin_info_file,'deltat_pos_err',period/nph)

#             self.write_to_obs_info(self.fasebin_info_file,'deltat_neg',delays[delays<0][-1])
#             self.write_to_obs_info(self.fasebin_info_file,'deltat_neg_err',period/nph)

#             self.write_to_obs_info(self.fasebin_info_file,'deltat_absolute',absmax)
#             self.write_to_obs_info(self.fasebin_info_file,'deltat_absolute_err',period/nph)


#             ax_ccf.axvline(delays[delays>0][0],ls=':',color='b',alpha=0.5)
#             ax_ccf.axvline(delays[delays<0][-1],ls=':',color='r',alpha=0.5)
#             ax_ccf.axvline(absmax,ls='-',color='k',alpha=0.3)
